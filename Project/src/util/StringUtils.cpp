...
namespace fig
{
	...
	size_t find_scope_end(const fig::string& text, size_t start, char open, char close, char escape)
	{
	...
	size_t find_within_scope(const fig::string& text, size_t start, char needle, char open, char close, char escape, int32_t depth)
	{
		int32_t scope = 0;
		for (; start < text.size(); ++start)
		{
