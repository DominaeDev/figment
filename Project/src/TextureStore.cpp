...
{
	LoadTexture(pRenderer, Texture::BORDER, "./resources/images/line.png");
	LoadTexture(pRenderer, Texture::BG_9GRID, "./resources/images/bg_9grid.png");
	LoadTexture(pRenderer, Texture::BORDER_9GRID, "./resources/images/bg_9grid_border.png");
}
