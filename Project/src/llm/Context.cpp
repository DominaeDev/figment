...
namespace fig::llm
{
	...
	void Context::DumpContext()
	{
		...
		{
			dump_batch_text(*this, i, std::format("prompt_text_{}.txt", i));
			dump_batch_tokens(*this, i, std::format("prompt_full_{}.txt", i));
			dump_kv_cache(*this, i, std::format("kvcache_{}.txt", i));
		}
		dump_kv_cache_cells(*this, "kvcache_alloc.txt");
#endif
	}
