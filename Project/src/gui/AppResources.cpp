...
namespace fig
{
	...
	void AppResources::Init(fig::renderer_ptr pRenderer)
	{
		...
		LoadTexture(pRenderer, Resource::ICON_ARCHIVE, "./resources/gui/icons/icon_archive.png");
		LoadTexture(pRenderer, Resource::ICON_UNARCHIVE, "./resources/gui/icons/icon_unarchive.png");
