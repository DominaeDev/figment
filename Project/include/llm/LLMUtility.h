...
namespace llm_util
{
	...
	llama_batch create_batch_view(llama_batch& batch, int32_t begin, int32_t end);
	...
	int32_t ctx_remove(llama_context* pCtx, ContextState& ctxState, std::vector<ContextBlock>::iterator itBegin, std::vector<ContextBlock>::iterator itEnd);
	int32_t ctx_remove_and_shift(llama_context* pCtx, ContextState& ctxState, std::vector<ContextBlock>::iterator itBegin, std::vector<ContextBlock>::iterator itEnd);
