...
public:
	...
	std::pair<std::reference_wrapper<llama_batch>, int32_t> GetBatch() { return std::make_pair<std::reference_wrapper<llama_batch>, int32_t>(static_cast<llama_batch&>(*_batch.get()), static_cast<int32_t>(_length)); }
	std::pair<std::reference_wrapper<llama_batch>, int32_t> GetBatch() const { return std::make_pair<std::reference_wrapper<llama_batch>, int32_t>(static_cast<llama_batch&>(*_batch.get()), static_cast<int32_t>(_length)); }
