...
namespace fig::gui
{
	...
	{
	public:
		Image(ParentPtr pParent, fig::texture_ptr pTexture, fig::color tint = { 0xFF, 0xFF, 0xFF, 0xFF });
		Image(ParentPtr pParent, Resource texture, fig::color tint = { 0xFF, 0xFF, 0xFF, 0xFF });
