...
namespace fig
{
	enum class Resource
	{
		...
		ICON_CROSS,
		ICON_DROPLIST_ARROW,
		ICON_CHARACTER_EDIT_INFO,
		ICON_CHARACTER_EDIT_VOICE,
		ICON_CHARACTER_EDIT_IMAGES,
		ICON_CHARACTER_EDIT_STORY,
		ICON_CHARACTER_EDIT_CONCEPTS,
		ICON_CHARACTER_EDIT_MEMORIES,
		ICON_CHARACTER_EDIT_ABOUT,
		ICON_CHARACTER_EDIT_INFO_SMALL,
		ICON_CHARACTER_EDIT_VOICE_SMALL,
		ICON_CHARACTER_EDIT_IMAGES_SMALL,
		ICON_CHARACTER_EDIT_STORY_SMALL,
		ICON_CHARACTER_EDIT_CONCEPTS_SMALL,
		ICON_CHARACTER_EDIT_MEMORIES_SMALL,
		ICON_CHARACTER_EDIT_ABOUT_SMALL,
