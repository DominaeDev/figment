...
namespace fig
{
	enum class Resource
	{
		...
		ROUNDED_BORDER_6PX,
		THICK_ROUNDED_BORDER_6PX,
		ROUNDED_BACKGROUND_10PX,
		ROUNDED_BORDER_10PX,
		THICK_ROUNDED_BORDER_10PX,
		SUBMENU_ARROW,
		...
		ICON_CHARACTER_EDIT_RULES,
		ICON_CHARACTER_EDIT_TRAITS,
		...
		ICON_CHARACTER_EDIT_RULES_SMALL,
		ICON_CHARACTER_EDIT_TRAITS_SMALL,
		ICON_CHARACTER_EDIT_ATTRIBUTE_SETTINGS,
		ICON_CHARACTER_EDIT_ATTRIBUTE_MOVE_UP,
		ICON_CHARACTER_EDIT_ATTRIBUTE_MOVE_DOWN,
		ICON_USER_SETTINGS_EDIT_APPLICATION,
		ICON_USER_SETTINGS_EDIT_APPLICATION_SMALL,
		ICON_USER_SETTINGS_EDIT_PROFILE,
		ICON_USER_SETTINGS_EDIT_PROFILE_SMALL,
		ICON_USER_SETTINGS_EDIT_ADVANCED,
		ICON_USER_SETTINGS_EDIT_ADVANCED_SMALL,
