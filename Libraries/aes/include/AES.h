...
#if (defined(__x86_64) || defined(__x86_64__) || defined(__amd64) || defined(__amd64__)) && !defined(USE_CXX_AES) && !defined(USE_NEON_AES)
#if defined(_MSC_VER)
#include <intrin.h>
#endif
...
#define HARDWARE_ACCELERATION_INTEL_AESNI
#endif
#elif (defined(__arm64__) || defined(__aarch64__) || defined(_M_ARM)) && !defined(USE_CXX_AES) && !defined(USE_INTEL_AESNI)
#if defined(__GNUC__)
#include <stdint.h>
#endif
